...
/**
 * Central kayit akisinin tamami: tenant ve sahip kullanici. Bunlarin hepsi ya
 * olur ya da hicbiri kalmaz.
 *
 ...
 * DROP SCHEMA CASCADE zincirini calistirir.
 */
final class RegisterTenant
{
    /**
     * @param  array{company: string, name: string, email: string, password: string}  $input
