...
export default function AttributeCreate({
    ...
    const [isVariantDefining, setIsVariantDefining] = useState<boolean>(true);
    ...
    return (
        <>
            <Head title="Yeni Özel Alan / Varyant Türü Tanımla" />
                ...
                <div className="rounded-xl border border-border bg-card p-4 shadow-xs sm:p-5">
                    <div className="space-y-1">
                        <h1 className="font-sans text-xl font-bold tracking-tight text-foreground sm:text-2xl">
                            Yeni Özel Alan / Varyant Türü Tanımla
                        </h1>
                        <p className="text-xs text-muted-foreground">
                            Sezon bilgisi, cinsiyet, beden, renk gibi özel
                            alanlar ve varyasyon türleri tanımlayın.
                        </p>
                    </div>
                </div>
