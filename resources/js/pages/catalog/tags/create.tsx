...
import { ArrowLeft, Loader2, Save, Tag as TagIcon } from 'lucide-react';
                ...
                <div className="rounded-xl border border-border bg-card p-4 shadow-xs sm:p-5">
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Ürünlerinize etiketler ekleyerek filtrelemeyi ve
                            dışa aktarma işlemlerini kolaylaştırın.
                        </p>
                    </div>
                </div>
                                ...
                                <Card className="gap-0 overflow-hidden border-border bg-card py-0 shadow-xs">
                                    <CardHeader className="border-b border-border bg-muted/40 px-4 py-3">
                                        ...
                                        <CardDescription className="text-xs">
                                            Etiket adını ve filtreleme kodunu
                                            belirleyin.
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4 p-4">
                                        <div className="grid gap-1.5">
                                            ...
                                            <Input
                                                ...
                                                placeholder="Örn: Yeni Sezon, Çok Satan, Fırsat..."
