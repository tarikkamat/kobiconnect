...
import { index } from '@/routes/dynamic-categories';
...
export default function DynamicCategoryCreate({
    fields = [],
    operators = [],
}: {
    fields: Option[];
    ...
    return (
        <>
            <Head title="Yeni Dinamik Kategori Ekle" />
            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-5 p-4 font-sans sm:p-6 lg:p-8">
                ...
                <div className="rounded-xl border border-border bg-card p-4 shadow-xs sm:p-5">
                    <div className="space-y-1">
                        <h1 className="font-sans text-xl font-bold tracking-tight text-foreground sm:text-2xl">
                            Yeni Dinamik Kategori Ekle
                        </h1>
                        <p className="text-xs text-muted-foreground">
                            Belirleyeceğiniz koşullara uyan mevcut ve yeni
                            ürünler bu kategoriye otomatik olarak eklenir.
                        </p>
                    </div>
                </div>
                ...
                {/* Form */}
                <Form
                    {...DynamicCategoryController.store.form()}
