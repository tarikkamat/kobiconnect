...
} from '@/components/orders/order-preview-sheet';
import {
    OrderStatusBadge,
    PENDING_PAYMENT,
            ...
            <div className="flex flex-col gap-5 p-4 sm:p-6 font-sans">
                ...
                {hasPendingPayment &&
                    filters.status !== 'pending_payment' && (
                        <div className="flex items-center justify-between gap-3 rounded-lg border border-warning/25 bg-warning/10 px-4 py-3 text-xs sm:text-sm text-warning">
                ...
                {filters.unmatched && (
                    <div className="flex items-center justify-between gap-3 rounded-lg border border-destructive/25 bg-destructive/10 px-4 py-2.5 text-xs sm:text-sm text-destructive">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <div className="relative min-w-64 flex-1">
                            ...
                            <div className="absolute top-1/2 right-2 flex -translate-y-1/2 items-center gap-1">
                                ...
                                {!searchValue && (
                                    <kbd className="hidden sm:inline-flex h-5 select-none items-center gap-1 rounded border border-border bg-muted px-1.5 font-sans text-[10px] text-muted-foreground">
                                        /
                                    </kbd>
                                )}
                            </div>
                        ...
                        >
                            ...
                            {unmatchedTotal > 0 && (
                                <Badge
                                    variant="destructive"
                                    className="ml-1 h-4 font-sans text-[10px] tabular-nums font-semibold"
                                >
                                    {unmatchedTotal}
                                </Badge>
                            )}
                                                ...
                                                <TableCell className="text-right font-sans tabular-nums">
                                                    <div className="flex items-center justify-end gap-1.5">
                                                        ...
                                                        {order.unmatchedCount >
                                                            ...
                                                            <Badge
                                                                variant="destructive"
                                                                className="h-4 font-sans text-[10px] tabular-nums font-semibold"
                                                            >
                                                                {
                                                                    order.unmatchedCount
                                                                }{' '}
