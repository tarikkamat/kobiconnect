...
/** Fonksiyon, sabit degil — bkz. app-sidebar.tsx. */
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        <div className="relative flex items-center space-x-1">
                            <Button
                                variant="ghost"
                                size="icon"
                                className="group size-[34px] cursor-pointer"
                            >
                                    ...
                                    <Tooltip key={item.title}>
                                        <TooltipTrigger>
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="group inline-flex size-[34px] items-center justify-center rounded-md bg-transparent p-0 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground disabled:pointer-events-none disabled:opacity-50"
                                            >
